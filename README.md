...
End-to-end data analytics project using SQL for ETL and Power BI for executive-level reporting. Identified key churn drivers for a bank and developed strategic retention recommendations.
-- The Challenge
